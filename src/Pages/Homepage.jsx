  ...
  return (
    ...
    <div className="w-full flex h-full justify-center my-2 overflow-auto bg-fixed">
      ...
      <div className="w-[90%] h-fill flex">
        ...
        <div
          className="w-full h-fit md:w-2/3 flex flex-col items-center justify-between
        ...
        >
          <div className="w-full h-full flex flex-col items-center">
            ...
            <div className="w-full lg:w-4/5 mb-1">
              ...
              <button
                className="bg-[#72a3e9] hover:bg-[#2e4b75] text-md 
          ...
          <div
            className="md:hidden w-full h-fill rounded bg-[#f4faff]
        ...
        <div
          className="hidden md:block w-1/3 h-full rounded bg-[#f4faff]
                                 shadow-md ml-1 bg-fixed overflow-scroll"
        >
          {/* render the suggestion list */}
          <Suggestions />
